...
| **2. 縣市平均** | `_縣市平均.xlsx` | `縣市` \| `到考人數` \| **`精熟/基礎/待加強人數與率(%)`** \| `總答對率` \| `向度明細` |
| **3. 各校平均** | `_各校平均.xlsx` | `學校代碼` \| `學校名稱` \| `到考人數` \| **`精熟/基礎/待加強人數與率(%)`** \| `總答對率` \| `向度明細` |
| **4. 各班平均** | `_各班平均.xlsx` | `學校代碼` \| `班級代碼` \| `到考人數` \| **`精熟/基礎/待加強人數與率(%)`** \| `總答對率` \| `向度明細` |
| **5. 縣市區域平均** | `_縣市區域平均.xlsx` | `縣市` \| `鄉鎮區` \| `到考人數` \| **`精熟/基礎/待加強人數與率(%)`** \| `總答對率` \| `向度明細` |
| **6. 不同家庭背景平均**| `_不同家庭背景平均.xlsx` | `縣市` \| `身分別` \| `到考人數` \| **`精熟/基礎/待加強人數與率(%)`** \| `總答對率` \| `向度明細` |
