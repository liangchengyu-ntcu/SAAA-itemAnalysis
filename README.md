...
| **7. 縣市平均 (等級描述-扣除特殊生)** | `_縣市平均(等級描述-扣除特殊生).xlsx` | `縣市` \| `到考人數` \| `總答對率` \| `精熟/基礎/待加強人數與率(%)` |
| **8. 縣市平均 (等級描述-含特殊生)** | `_縣市平均(等級描述-含特殊生).xlsx` | `縣市` \| `到考人數` \| `總答對率` \| `精熟/基礎/待加強人數與率(%)` |
| **9. 各校平均 (等級描述-扣除特殊生)** | `_各校平均(等級描述-扣除特殊生).xlsx` | `學校代碼` \| `學校名稱` \| `到考人數` \| `總答對率` \| `精熟/基礎/待加強人數與率(%)` |
| **10. 各校平均 (等級描述-含特殊生)** | `_各校平均(等級描述-含特殊生).xlsx` | `學校代碼` \| `學校名稱` \| `到考人數` \| `總答對率` \| `精熟/基礎/待加強人數與率(%)` |
| **11. 各班平均 (等級描述-扣除特殊生)** | `_各班平均(等級描述-扣除特殊生).xlsx` | `學校代碼` \| `班級代碼` \| `到考人數` \| `總答對率` \| `精熟/基礎/待加強人數與率(%)` |
| **12. 各班平均 (等級描述-含特殊生)** | `_各班平均(等級描述-含特殊生).xlsx` | `學校代碼` \| `班級代碼` \| `到考人數` \| `總答對率` \| `精熟/基礎/待加強人數與率(%)` |
| **13. 縣市區域平均 (等級描述-扣除特殊生)** | `_縣市區域平均(等級描述-扣除特殊生).xlsx` | `縣市` \| `鄉鎮區` \| `到考人數` \| `總答對率` \| `精熟/基礎/待加強人數與率(%)` |
| **14. 縣市區域平均 (等級描述-含特殊生)** | `_縣市區域平均(等級描述-含特殊生).xlsx` | `縣市` \| `鄉鎮區` \| `到考人數` \| `總答對率` \| `精熟/基礎/待加強人數與率(%)` |
| **15. 家庭背景平均 (等級描述-扣除特殊生)** | `_不同家庭背景平均(等級描述-扣除特殊生).xlsx` | `縣市` \| `身分別` \| `到考人數` \| `總答對率` \| `精熟/基礎/待加強人數與率(%)` |
| **16. 家庭背景平均 (等級描述-含特殊生)** | `_不同家庭背景平均(等級描述-含特殊生).xlsx` | `縣市` \| `身分別` \| `到考人數` \| `總答對率` \| `精熟/基礎/待加強人數與率(%)` |
| **17. 總平均 (等級描述-扣除特殊生)** | `_總平均(等級描述-扣除特殊生).xlsx` | `科目` \| `年級` \| `到考人數` \| `總答對率` \| `精熟/基礎/待加強人數與率(%)` |
| **18. 總平均 (等級描述-含特殊生)** | `_總平均(等級描述-含特殊生).xlsx` | `科目` \| `年級` \| `到考人數` \| `總答對率` \| `精熟/基礎/待加強人數與率(%)` |
