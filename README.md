...
每個科目／年級分析完成後，系統會生成 **15 份 Excel 報表** 並壓縮打包提供下載：

| 報表類型 | 檔名後綴 / 格式 | 說明 |
| :--- | :--- | :--- |
| **1. 全體總答對率** | `全體總答對率.xlsx` | 學生總分與答對率明細 |
| **2. 縣市平均** | `_縣市平均.xlsx` | 各縣市平均分與答對率 |
| **3. 各校平均** | `_各校平均.xlsx` | 各學校平均分 |
| **4. 各班平均** | `_各班平均.xlsx` | 各班級平均分 |
| **5. 縣市區域平均** | `_縣市區域平均.xlsx` | 區域統計平均 |
| **6. 不同家庭背景平均**| `_不同家庭背景平均.xlsx` | 依身份/背景分組統計 |
| **7. 缺考名單** | `_缺考名單.xlsx` | 缺考學生名單（含兩種流水號） |
| **8. 個人成績含題數** | `_個人成績含題數.xlsx` | 個人分項答對題數 |
| **9. 全體名單成績** | `_全體名單成績含缺考.xlsx` | 含缺考之全體成績單 |
| **10. 個人成績** | `_個人成績.xlsx` | 原始作答、逐題得分與向度明細 |
| **11. 總平均** | `_總平均.xlsx` | 全體總平均統計 |
...
| **15. 縣市三等級試題分析**| `_縣市三等級試題分析.xlsx` | **對齊臺中教大規範**（全體/精熟/基礎/待加強） |
